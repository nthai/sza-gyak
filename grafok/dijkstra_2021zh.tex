...
\begin{scope}
		...
		\draw[-] (a) to node[edgelabel] {6} (b);
		\draw[-] (a) to node[edgelabel] {1} (d);
		\draw[-] (a) to [bend right] node[edgelabel] {2} (g);
		\draw[-] (b) to node[edgelabel] {1} (c);
		\draw[-] (b) to node[edgelabel] {4} (e);
		\draw[-] (c) to node[edgelabel] {2} (e);
		\draw[-] (c) to node[edgelabel] {2} (f);
		\draw[-] (d) to node[edgelabel] {5} (e);
		\draw[-] (d) to node[edgelabel] {2} (g);
		\draw[-] (e) to node[edgelabel] {4} (f);
		\draw[-] (e) to node[edgelabel] {1} (i);
		\draw[-] (e) to node[edgelabel] {3} (h);
		\draw[-] (f) to node[edgelabel] {2} (i);
		\draw[-] (g) to node[edgelabel] {4} (h);
