...
\begin{tikzpicture}
    ...
    \node[mynode, label=90:{$(5)$}] (a) at (-2.0, 1) {a};
    \node[mynode, label=90:{$(5)$}] (b) at (-2.5, -0.5) {b};
    \node[mynode, label=270:{$(5)$}] (c) at (-1.7, -1.3) {c};
    ...
    \draw[-] (a) to node[edgelabel, near start] {$3$} (f);
    \draw[-] (b) to node[edgelabel] {$4$} (e);
    \draw[-] (c) to node[edgelabel] {$5$} (e);
    \draw[-] (b) to node[edgelabel] {$6$} (g);
