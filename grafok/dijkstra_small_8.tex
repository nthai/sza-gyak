...
\begin{tikzpicture}
    ...
    \node[mynode, label=90:{$(4)$}] (a) at (-2.0, 1) {a};
    ...
    \draw[-] (a) to node[edgelabel, near start] {$4$} (f);
    \draw[-] (b) to node[edgelabel] {$1$} (e);
    \draw[-] (b) to node[edgelabel, near start] {$1$} (f);
    \draw[-] (c) to node[edgelabel] {$5$} (e);
    \draw[-] (c) to node[edgelabel] {$5$} (f);
