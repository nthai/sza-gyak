\documentclass[tikz]{standalone}
    ...
    \begin{tikzpicture}
        ...
        \draw[-{>[length=5, width=5]}] (s) to node[edgelabel,sloped] {$3(3)$} (a);
        \draw[-{>[length=5, width=5]}] (s) to node[edgelabel,sloped] {$1(3)$} (b);
        \draw[-{>[length=5, width=5]}] (b) to node[edgelabel,sloped] {$0(3)$} (a);
        \draw[-{>[length=5, width=5]}] (a) to node[edgelabel,sloped] {$3(5)$} (t);
        \draw[-{>[length=5, width=5]}] (b) to node[edgelabel,sloped] {$1(1)$} (t);
    \end{tikzpicture}
    \end{document}