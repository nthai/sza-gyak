...
\begin{tikzpicture}
    ...
    \node[mynode, label=90:{$(1)$}] (a) at (-2.0, 1) {a};
    \node[mynode, label=90:{$(1000)$}] (b) at (-2.5, -0.5) {b};
    \node[mynode, label=270:{$(3)$}] (c) at (-1.7, -1.3) {c};
    ...
    \draw[->] (a) to node[edgelabel] {$3000$} (d);
    \draw[->] (a) to node[edgelabel] {$2000$} (e);
    \draw[->] (a) to node[edgelabel, near start] {$3000$} (f);
    \draw[->] (b) to node[edgelabel] {$42$} (e);
    \draw[->] (c) to node[edgelabel, near start] {$14000605$} (e);
    \draw[->] (c) to node[edgelabel] {$69420$} (g);
