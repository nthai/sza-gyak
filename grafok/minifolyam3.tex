\documentclass[tikz]{standalone}
    ...
    \begin{tikzpicture}
        ...
        \draw[-{>[length=5, width=5]}] (s) to node[edgelabel,sloped] {$4(6)$} (a);
        \draw[-{>[length=5, width=5]}] (s) to node[edgelabel,sloped] {$3(3)$} (b);
        \draw[-{>[length=5, width=5]}] (a) to node[edgelabel,sloped] {$0(3)$} (b);
        \draw[-{>[length=5, width=5]}] (a) to node[edgelabel,sloped] {$4(5)$} (t);
        \draw[-{>[length=5, width=5]}] (b) to node[edgelabel,sloped] {$3(4)$} (t);
    \end{tikzpicture}
    \end{document}