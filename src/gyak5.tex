    ...
    \begin{enumerate}
        ...
        \begin{figure}[!h]
            ...
            \begin{subfigure}{0.2\textwidth}
                \centering
                \includestandalone[width=0.7\textwidth]{../grafok/bfs_after_1}
            \end{subfigure}
            \begin{subfigure}{0.2\textwidth}
                \centering		
                \includestandalone[width=0.7\textwidth]{../grafok/bfs_after_2}
            \end{subfigure}
            \begin{subfigure}{0.2\textwidth}
                \centering
                \includestandalone[width=0.7\textwidth]{../grafok/bfs_after_3}
            \end{subfigure}
            \begin{subfigure}{0.2\textwidth}
                \centering
                \includestandalone[width=0.7\textwidth]{../grafok/bfs_after_4}
            \end{subfigure}
        \end{figure}
        ...
        \begin{figure}[!h]
            ...
            \begin{subfigure}{0.24\textwidth}
                \centering
                \includestandalone[width=\textwidth]{../grafok/dijkstra_small_7}
            \end{subfigure}
            \begin{subfigure}{0.24\textwidth}
                \centering
                \includestandalone[width=\textwidth]{../grafok/dijkstra_small_8}
            \end{subfigure}
            \begin{subfigure}{0.24\textwidth}
                \centering
                \includestandalone[width=\textwidth]{../grafok/dijkstra_small_9}
            \end{subfigure}
            \begin{subfigure}{0.24\textwidth}
                \centering
                \includestandalone[width=\textwidth]{../grafok/dijkstra_small_10}
            \end{subfigure}
        \end{figure}
