\documentclass[a4paper, 12pt]{article}
    ...
    \begin{document}
        ...
        \begin{enumerate}
            ...
            % Amíg a Mortal Kombat harci torna szünetel, Skorpió és néhány barátja úgy döntenek, hogy részmun-kaidősnek mennek a helyi fatelepre. Első nap rögtön egy nagyon fontos feladatot kapnak. A fűrészgépek között nem lettek pontosan szétosztva reggel a gerendák, valahova több érkezett, valahol pedig hiány keletkezett. A fatelep fűrészgépei közötti utakat az alábbi bal oldali gráf szemlélteti, két fűrészgép akkor van összekötve, ha van köztük (kétirányú) út, az egyes fűrészgépek felett számok ábrázolják a munkadarabokat (zárójelben az, hogy pontosan mennyi gerendára van szükségük). Minden egyes fűrészgépnél több harcos is állomásozik, akik a fűrészgépüknél lévő munkadarabokat át tudják vinni egy szomszédos fűrészgéphez. Szét lehet-e osztani a gerendákat úgy, hogy minden fűrészgépnél pontosan annyi legyen, amennyire szükség van ott úgy, hogy a harcosoknak legfeljebb csak egyszer kelljen szállítaniuk? (A harcosok egyszerre indulnak el a fűrészgépektől, azaz senki nem várhatja meg, hogy a másik áthozzon neki valamennyi gerendát.)
            % \begin{figure}[!h]
            %     \centering
            %     \begin{subfigure}{0.4\textwidth}
            %         \centering		
